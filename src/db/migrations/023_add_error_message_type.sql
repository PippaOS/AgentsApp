...
CREATE TABLE messages_new (
  ...
  response_json TEXT,
  model TEXT,
  message_type TEXT NOT NULL DEFAULT 'text' CHECK(message_type IN ('text', 'file_system', 'chat_context', 'tool_call', 'tool_result', 'image_generation_call', 'error')),
  entity_id TEXT,
...
INSERT INTO messages_new (
  ...
  message_type, entity_id, tool_calls_json, tool_call_id, tool_name, tool_input, tool_output, cost, chat_context_id, created_at
)
SELECT
  id, public_id, chat_id, role, content, reasoning, reasoning_details_json, response_json, model,
  message_type, entity_id, tool_calls_json, tool_call_id, tool_name, tool_input, tool_output, cost, chat_context_id, created_at
